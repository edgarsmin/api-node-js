...
2. GET: Пользователь отсутствует. Запрос всех пользователей.
3. POST: Создание пользователя.
4. GET: Получить существ пользователя по ID.
5. GET: Получить несущ пользователя по ID.
6. GET: Неверный формат id. например alphanumeric формат 'abc123'.
7. DELETE: Удаление сущ пользователя по id.
8. DELETE: Удаление несущ пользователя.
